...
void Reply::sendIRCReply(int code, const std::unordered_map<std::string, std::string>& params) {
   std::unordered_map<int, std::string>::iterator it = _ReplyTemplates.find(code);
