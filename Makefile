...
SRCS_FILE = main.cpp IRCServer.cpp Client.cpp client_checker.cpp cmds/find_cmd.cpp cmds/join.cpp cmds/nick.cpp cmds/pass.cpp cmds/privmsg.cpp cmds/quit.cpp
